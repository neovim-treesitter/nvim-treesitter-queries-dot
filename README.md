# nvim-treesitter-queries-dot

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-dot/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-dot/actions/workflows/validate.yml)

Neovim tree-sitter queries for **dot**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-dot",
...
- [ ] Changes are scoped to `dot` — do not include files for other languages
